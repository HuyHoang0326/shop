...
<!-- Mirrored from htmldemo.net/antomi/antomi by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2022 06:48:26 GMT -->
<body>
            ...
            <div class="blog_page_section ">
                <div class="row">
                    <div class="col-lg-9 col-md-12">
                        <div class="blog_wrapper blog_fullwidth mb-60">
                            ...
                            <div class="blog_wrapper_inner">
                                <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{ route('blogfull') }}"><img src="{{ asset('img/blog/blog-big1.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            ...
                                            <p class="post_desc">Donec vitae hendrerit arcu, sit amet faucibus nisl.
                                                ...
                                                rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et
                                                metus pharetra, bibendum massa nec, fermentum odio. Nunc id leo
                                                ultrices, mollis ligula in, finibus tortor. Mauris</p>
                                    ...
                                    <figure>
                                        <div class="blog_thumb blog_thumb_active owl-carousel">
                                            <div class="single_blog_thumb">
                                                <a href="#"><img src="{{ asset('img/blog/blog-big2.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="single_blog_thumb">
                                                <a href="#"><img src="{{ asset('img/blog/blog-big1.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="single_blog_thumb">
                                                <a href="#"><img src="{{ asset('img/blog/blog-big3.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="single_blog_thumb">
                                                <a href="#"><img src="{{ asset('img/blog/blog-big4.jpg') }}" alt=""></a>
                                            </div>
                                            <div class="single_blog_thumb">
                                                <a href="#"><img src="{{ asset('img/blog/blog-big5.jpg') }}" alt=""></a>
                                            </div>
                                        </div>
                                        <figcaption class="blog_content">
                                ...
                                <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{ route('blogfull') }}"><img src="{{ asset('img/blog/blog-big3.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                            ...
                                            <p class="post_desc">Donec vitae hendrerit arcu, sit amet faucibus nisl.
                                                Cras pretium arcu ex. Aenean posuere libero eu augue condimentum
                                                rhoncus. Praesent ornare tortor ac ante egestas hendrerit. Aliquam et is
                                            </p>
                                            <footer class="btn_more">
                                                <a href="{{ route('blogfull') }}"> Read more</a>
                                            </footer>
                                ...
                                <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{ route('blogfull') }}"><img src="{{ asset('img/blog/blog-big4.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                                ...
                                <article class="single_blog">
                                    <figure>
                                        <div class="blog_thumb">
                                            <a href="{{ route('blogfull') }}"><img src="{{ asset('img/blog/blog-big5.jpg') }}"
                                                    alt=""></a>
                                        </div>
                                        <figcaption class="blog_content">
                            ...
                            <div class="widget_list comments">
                                ...
                                <div class="post_wrapper">
                                    <div class="post_thumb">
                                        <a href="{{ route('blogfull') }}"><img src="{{ asset('img/blog/comment2.png.jpg') }}"
                                                alt=""></a>
                                    </div>
                                    <div class="post_info">
                        ...
                        <div class="widgets_container contact_us">
                            ...
                            <div class="app_img">
                                <figure class="app_img">
                                    <a href="#"><img src="{{ asset('img/icon/icon-appstore.jpg') }}" alt=""></a>
                                </figure>
                                <figure class="app_img">
                                    <a href="#"><img src="{{ asset('img/icon/icon-googleplay.jpg') }}" alt=""></a>
                                </figure>
                            </div>
                        </div>
                    </div>
                            ...
                            <div class="footer_contact">
                                <div class="footer_contact_inner">
                                    <div class="contact_icone">
                                        <img src="{{ asset('img/icon/icon-phone.jpg') }}" alt="">
                                    </div>
                ...
                <div class="row align-items-center">
                    ...
                    <div class="col-lg-6 col-md-6">
                        <div class="footer_payment text-right">
                            <img src="{{ asset('img/icon/payment.jpg') }}" alt="">
                        </div>
                    </div>
                </div>
            </div>
...
<!-- Mirrored from htmldemo.net/antomi/antomi/{{ route('blogfull') }} by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 21 Nov 2022 06:48:27 GMT -->
</html>
@endsection